...
export const Navbar = () => {
  return (
    <div>
      <nav className="bg-white border-gray-200   rounded dark:bg-cyan-900">
            ...
            <ul className="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-cyan-900 md:dark:bg-cyan-900 dark:dark:bg-cyan-900">
             ...
             DISCOVER
              ...
              <li>
                <a
                  href="#"
                  className="  pr-7 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:rounded-xl md:bg-amber-500 md:hover:text-blue-700 md:px-3 md:py-1    dark:text-white md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
                >
                  SIGN UP
                </a>
              </li>
